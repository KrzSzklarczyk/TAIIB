...
namespace DataAccesLayer.Migrations
{
    ...
    public partial class start : Migration
    {
        ...
        {
            return obj is start start &&
                   EqualityComparer<IModel>.Default.Equals(TargetModel, start.TargetModel) &&
                   EqualityComparer<IReadOnlyList<MigrationOperation>>.Default.Equals(UpOperations, start.UpOperations) &&
                   EqualityComparer<IReadOnlyList<MigrationOperation>>.Default.Equals(DownOperations, start.DownOperations) &&
                   ActiveProvider == start.ActiveProvider;
        }
    }
}
